...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/timepicker.css">
     <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/daterangepicker-bs3.css">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form"  method="get" action="<%=request.getContextPath()%>/addevent">
                                  <input type="hidden" name="flag" value="f">
                                      ...
                                      <div class="form-group ">
                                       ...
                                       <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Venue:</label>
                                          <div class="col-lg-7">
                                          <input class=" form-control" id="cname" name="venue" minlength="2" type="text" required />
                                              
                                          </div>
                                      </div>
                                      <div class="form-group">
                                                  <label class="control-label col-md-2">Event Date Range:</label>
                                                  <div class="col-md-7">
                                  ...
                                  <div class="form-group">
                                          <label for="ccomment" class="control-label col-lg-2">Upload Event Image</label>
                                          <div class="col-md-4">
                                             <!--  <input type="file" class="default"> -->
                                             <iframe src="fileupload.jsp" width="100%" height="200"> </iframe>
