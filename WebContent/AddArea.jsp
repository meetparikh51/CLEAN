                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" name="areaform" method="get" action="<%=request.getContextPath()%>/addarea">
                                  <input type="hidden" name="flag" value="f">
                                  <div class="form-group ">
                                        <label for="zname" class="control-label col-lg-2">Zone:</label>
                                        <div class="col-lg-10">
                                         <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
                                         <select class="form-control " id="zname" name="zone" required="required" onchange="loadState()">
                                      ...
                                      <div class="form-group">
                                             ...
                                             <div class="col-lg-10">
                                              ...
                                              <input class=" form-control" id="cname" name="pincode" minlength="2" type="text" required />
                                          </div> 
                                          </div>
                                      <div class="form-group">
