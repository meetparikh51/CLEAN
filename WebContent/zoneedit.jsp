                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class=" form">
                                  <form   method="get" action="<%=request.getContextPath()%>/addzone">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Zone Name:</label>
                                         <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="p" %>
              								<p:forEach items="${sessionScope.edit}" var="i">
              								<tr>
                  							<td><input type="text" name=n1 value="${i.zoneName}"> </td>
  											</tr>
               								</p:forEach>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="p" %>
              								<p:forEach items="${sessionScope.edit}" var="i">
              								<tr>
                  							<td><textarea name="n2">"${i.description}"</textarea></td>
  											</tr>
  											<input type="hidden" name="id" value="${i.zoneId}">
               								</p:forEach>
