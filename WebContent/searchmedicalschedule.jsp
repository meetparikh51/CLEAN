...
<html lang="en">
  <head>
    ...
    <title>Search Medical Schedule</title>
          ...
          <section class="wrapper">
             ...
             <span class="tools pull-right">
              ...
              <tr>
                  ...
                  <td>${i.time}</td>
                  <td><a href="<%=request.getContextPath()%>/medicalwaste?medicalwasteid=${i.medicalwasteId}&flag=delete">delete</a>
