...
body.bgpattern { background-image: url(User/images/gravel.png); background-repeat: repeat;background-size: auto;}
    ...
    <div id="mainwrapper">
      ...
      <div class="center">
        ...
        <div class="maincontent-full">
          <!-- Contact Form -->
          <div id="conctactleft">
                                   <h1 font color="Green" allign="center">Post Complain</h1>
                       
            <div id="maincontactform">
              <form action="<%=request.getContextPath()%>/postcomplain?flag=insert" id="contactform" method="get"> 
              <div>
              
              <div class="form-group ">
                                          Subject
                                          <div class="col-lg-10">
                                              <input class=" textfield" id="cname" name="area" minlength="2" type="text" style="height:35px"/><span class="require"> *</span><br/>
                                          </div>
              ...
              <div>
                Description
                <p>
                <textarea rows="9" cols="49" name="description"></textarea> 
                </p>
                </div>
