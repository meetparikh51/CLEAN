    ...
    <div id="mainwrapper">
      ...
      <div class="center">
        ...
        <div class="maincontent-full">
          <!-- Contact Form -->
          <div id="conctactleft">
                                   <h1 font color="Green" allign="center">Medical Pickup Schedule</h1>
                       
            <div id="maincontactform">
              <form action="<%=request.getContextPath()%>/medicalwaste" name="areaform" id="contactform" method="get"> 
              <div>
