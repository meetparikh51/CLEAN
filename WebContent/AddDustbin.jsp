                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form"  method="post" action="<%=request.getContextPath()%>/adddustbin?flag=insert">
                                     ...
                                     <div class="form-group ">
                                        ...
                                        <div class="col-lg-7">
                                         ...
                                         <select class="form-control " id="aname" name="Area" required>
											<c:forEach items="${sessionScope.search2}" var="x">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-2">
                                              <input class=" form-control" id="cname" name="longitude" minlength="2" type="text" required />
                                          </div>
                                      </div>
