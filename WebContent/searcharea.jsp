          ...
          <section class="wrapper">
             ...
             <span class="tools pull-right">
              ...
              <tr>
                  ...
                  <td><a href="<%=request.getContextPath()%>/addarea?areaid=${i.areaId}&flag=edit">edit</a>/<a href="<%=request.getContextPath()%>/addarea?areaid=${i.areaId}&flag=delete">delete</a></td>
