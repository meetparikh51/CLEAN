...
<html lang="en">
  <head>
    ...
    <title>Medical Waste Schedule</title>
<!-- Bootstrap core CSS -->
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              Medical Waste Schedule
                          </header>
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form"  method="get" action="<%=request.getContextPath()%>/medicalwaste">                                      
