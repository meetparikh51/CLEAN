                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form"  method="get" action="<%=request.getContextPath()%>/MessageAll">
                                  <input type="hidden" name="flag" value="insert2">
                                  <div class="form-group ">
                                        <label for="zname" class="control-label col-lg-2">To:</label>
                                        <div class="col-lg-7">
											<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
                                         <select class="form-control " id="zname" name="users" required>
											<c:forEach items="${sessionScope.search}" var="x">
                                              <option value="${x.user_Id }">${x.email }</option>
											</c:forEach>
                                          </select>
                                          </div>
                                      ...
                                      <div class="form-group">
                                          <label for="ccomment" class="control-label col-lg-2">Upload Document:</label>
                                          <div class="col-md-4">
