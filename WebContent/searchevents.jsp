             ...
             <span class="tools pull-right">
              ...
              <tr>
                 <td>${i.eventName}</td>
                  ...
                  <td>${i.date}</td>
                  <td>${i.time}</td>
                  <td><a href="<%=request.getContextPath()%>/addevent?eventid=${i.eventId}&flag=edit">edit</a>/<a href="<%=request.getContextPath()%>/addevent?eventid=${i.eventId}&flag=delete">delete</a></td>
