                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form"  method="get" action="<%=request.getContextPath()%>/addtender">                                      <div class="form-group ">
                                        ...
                                        <label for="cname" class="control-label col-lg-2">Tender Number:</label>
                                          <div class="col-lg-7">
                                              <input class=" form-control" id="cname" name="tenderno" minlength="2" type="text" required />
                                          </div>
                                          ...
                                          <div class="col-lg-7">
                                              <input class=" form-control" id="cname" name="tendername" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">Tender Amount:</label>
                                          <div class="col-lg-7">
                                              <input class=" form-control" id="cname" name="amount" minlength="2" type="text" required />
                                          </div>
                                      ...
                                      <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">Staff Required:</label>
                                          <div class="col-lg-7">
                                              <input class=" form-control" id="cname" name="staffno" minlength="2" type="text" required />
                                          </div>
