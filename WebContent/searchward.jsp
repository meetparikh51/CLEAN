...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">
             ...
             <span class="tools pull-right">
              ...
              <tr>
              	  <td>${i.zoneId.zoneName}</td>
                  <td>${i.wardName}</td>
                  <td>${i.description}</td>
                  <td><a href="<%=request.getContextPath()%>/addward?wardid=${i.wardId}&flag=edit">edit</a>/<a href="<%=request.getContextPath()%>/addward?wardid=${i.wardId}&flag=delete"">delete</a></td>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/DT_bootstrap.js"></script>
