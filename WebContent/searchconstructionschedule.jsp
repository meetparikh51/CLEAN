...
<html lang="en">
  <head>
    ...
    <title>Search Construction Schedule</title>
          ...
          <section class="wrapper">
             ...
             <span class="tools pull-right">
              ...
              <tr>
                  ...
                  <td>${i.time}</td>
                  <td><a href="<%=request.getContextPath()%>/constructionwaste?constructionwasteid=${i.constructionwasteId}&flag=delete">delete</a>
