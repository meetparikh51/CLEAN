          ...
          <section class="wrapper">
             ...
             <span class="tools pull-right">
              ...
              <tr>
                  ...
                  <td>${i.time}</td>
                  <td><a href="<%=request.getContextPath()%>/addschedule?scheduleid=${i.scheduleId}&flag=edit">edit</a>/<a href="<%=request.getContextPath()%>/addschedule?scheduleid=${i.scheduleId}&flag=delete">delete</a></td>
