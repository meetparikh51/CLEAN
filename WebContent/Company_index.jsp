...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" src="${pageContext.request.contextPath}/imgfavicon.png">
    ...
    <!--[if lt IE 9]>
      <script src="${pageContext.request.contextPath}/jshtml5shiv.js"></script>
      <script src="${pageContext.request.contextPath}/jsrespond.min.js"></script>
    <![endif]-->
  </head>
                      ...
                      <section class="panel">
                          <div class="panel-body">
                              <a href="#" class="task-thumb">
                                  <img src="${pageContext.request.contextPath}/imgavatar1.jpg" alt="">
                              </a>
                                          ...
                                          <div class="timeline-desk">
                                              <div class="panel">
                                                  <div class="panel-body">
                                                      ...
                                                      <div class="album">
                                                          <a href="#">
                                                              <img alt="" src="${pageContext.request.contextPath}/imgsm-img-1.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="${pageContext.request.contextPath}/imgsm-img-2.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="${pageContext.request.contextPath}/imgsm-img-3.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="${pageContext.request.contextPath}/imgsm-img-1.jpg">
                                                          </a>
                      ...
                      <section class="panel post-wrap pro-box">
                          ...
                          <aside class="post-highlight yellow v-align">
                              <div class="panel-body text-center">
                                  <div class="pro-thumb">
                                      <img src="${pageContext.request.contextPath}/imgring.jpg" alt="">
                                  </div>
                              </div>
                          </aside>
                      </section>
                                  ...
                                  <div class="follower">
                                      <div class="panel-body">
                                          ...
                                          <div class="follow-ava">
                                              <img src="${pageContext.request.contextPath}/imgfollower-avatar.jpg" alt="">
                                          </div>
                                      </div>
                                  </div>
      ...
      <div class="sb-slidebar sb-right sb-style-overlay">
          ...
          <ul class="quick-chat-list">
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="${pageContext.request.contextPath}/imgchat-avatar2.jpg" class="media-object">
                      </a>
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="${pageContext.request.contextPath}/imgchat-avatar.jpg" class="media-object">
                      </a>
                      <div class="media-body">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="${pageContext.request.contextPath}/imgpro-ac-1.png" class="media-object">
                      </a>
                      <div class="media-body">
                          <div class="media-status">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="${pageContext.request.contextPath}/imgavatar1.jpg" class="media-object">
                      </a>
                      <div class="media-body">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="${pageContext.request.contextPath}/imgmail-avatar.jpg" class="media-object">
                      </a>
                      <div class="media-body">
                          <div class="media-status">
