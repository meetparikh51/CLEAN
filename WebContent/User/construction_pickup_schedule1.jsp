...
<title>
Construction Pickup Schedule</title>
    ...
    <div id="mainwrapper">
      ...
      <div class="center">
        ...
        <div class="maincontent-full">
          <!-- Contact Form -->
          <div id="conctactleft">
                                   <h1 font color="Green" allign="center">Construction Pickup Schedule</h1>
                       
            <div id="maincontactform">
              <form action="<%=request.getContextPath()%>/constructionwaste" name="areaform" id="contactform" method="get"> 
              <div>
              
              <div class="form-group ">
              <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
              <c:forEach items="${sessionScope.edit}" var="y">
                                          Area Name:
                                          <!-- <div class="col-lg-10">
                                          ...
                                          <%-- <select class="textfield " id="aname" name="area"  type="text" required><span class="require"> *</span><br/>
											<c:forEach items="${sessionScope.search}" var="x">
												<c:if test="${x.areaId.areaId} eq ${y.areaId}">
                                              <option selected value="${x.areaId }">${x.areaName }</option>
											</c:if>
											</c:forEach>
                                          </select> --%>
                                           <input type="text" name="name" class="textfield" id="contactname" value="${y.areaId.areaName}"  placeholder="First name"/>
                                          
                                          <input type="text" name="name" class="textfield" id="contactname" value="${y.time}" placeholder="First name"/><span class="require"> *</span><br/>
               </c:forEach>
               
               </div>
                               <button class="button medium white" type="submit">Replan</button>
                <input type="hidden" name="flag" value="loadschedule">
                	
                
                <div class="clear"></div>
                <!--  <a href="#" class="button medium white" id="buttonsend">SHOW</a> -->
