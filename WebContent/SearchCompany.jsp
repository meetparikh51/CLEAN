          ...
          <section class="wrapper">
             ...
             <span class="tools pull-right">
              ...
              <tr>
                  <td>${i.zoneName}</td>
                  <td>${i.description}</td>
                  <td><a href="<%=request.getContextPath()%>/addzone?zoneid=${i.zoneId}&flag=edit">edit</a>/<a href="<%=request.getContextPath()%>/addzone?zoneid=${i.zoneId}&flag=delete">delete</a></td>
