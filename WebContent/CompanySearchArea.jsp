          ...
          <section class="wrapper">
             ...
             <span class="tools pull-right">
              ...
              <tr>
                  ...
                  <td>${i.description}</td>
                  <td><a href="<%=request.getContextPath()%>/areacompany?assignid=${i.assignId}&flag=edit">edit</a>/<a href="<%=request.getContextPath()%>/areacompany?assignid=${i.assignId}&flag=delete">delete</a></td>
