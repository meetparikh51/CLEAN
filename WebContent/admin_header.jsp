...
function loadnotification()
{
	...
	for(var i=size.innerHTML;i>0;i--)
		{
		size.innerHTML = 0;
...
<header class="header white-bg">
            ...
            <!--logo start-->
            <a href="Admin_index.jsp" class="logo"><span>C.L.E.A.N</span></a>
            <!--logo end-->
            <div class="nav notify-row" id="top_menu">
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_notification_bar" class="dropdown" onclick="loadnotification()">
                        <a data-toggle="dropdown" class="dropdown-toggle"  href="#">

                            <i class="fa fa-bell-o"></i>
                             
                           
                            <span class="badge bg-warning"id="size">${sessionScope.complain_size}</span>
                        ...
                        <ul class="dropdown-menu extended notification">
                            <div class="notify-arrow notify-arrow-yellow"></div>
                       		...
                       		<p:forEach items="${sessionScope.complain}" var="x">
                            <li>
                                 <span class="label label-danger"><i class="fa fa-bolt"></i></span>
                                    ${x.subject }
                                  <span class="small italic">${x.description }</span>
            ...
            <div class="top-nav ">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended n">
