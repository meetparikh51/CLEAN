                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form"  method="get" action="<%=request.getContextPath()%>/areacompany">                                      <div class="form-group ">
                                         
                                         <input type="hidden" name="flag" value="update">
                                          <label for="cname" class="control-label col-lg-2">Employee Name:</label>
                                          <div class="col-lg-7">
											<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
                                         <select class="form-control " id="aname" name="ename" required>
											<c:forEach items="${sessionScope.edit}" var="x">
                                              <option value="${x.assignId }">${x.staffId.name }</option>
                                              <input type="hidden" name="id" value="${x.assignId}">
											</c:forEach>
                                     ...
                                     <div class="form-group ">
                                         ...
                                         <select class="form-control " id="aname" name="area" required>
                                              ...
                                              <c:forEach items="${sessionScope.edit}" var="x">
                                              <option value="${x.assignId }">${x.areaId.areaName }</option>
											</c:forEach>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="p" %>
              								...
              								<tr>
              							<td><textarea class="form-control " id="ccomment" name="description" required>${i.description}</textarea></td>
