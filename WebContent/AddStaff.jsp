                                  ...
                                  <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                       <label for="cname" class="control-label col-lg-2">Email:</label>
                                          <div class="col-lg-6">
                                              <input class=" form-control" id="cname" name="email" minlength="2" type="text" required />
                                          </div>
                                      </div>
                              ...
                              <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                       <label for="cname" class="control-label col-lg-2">Phone no:</label>
                                          <div class="col-lg-6">
                                              <input class=" form-control" id="cname" name="phone" minlength="2" type="text" required />
                                          </div>
                                      </div>
