                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
                                  <form class="cmxform form-horizontal tasi-form" method="get" action="<%=request.getContextPath()%>/addarea">
                                  ...
                                  <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                         ...
                                         <select class="form-control " id="zname" name="zone" required="required">
											<c:forEach items="${sessionScope.search1}" var="x">
                                      ...
                                      <div class="form-group ">
                                        <label for="zname" class="control-label col-lg-2">Ward:</label>
                                        <div class="col-lg-10">
                                          
                                         <select class="form-control " id="wname" name="ward" required>
											<c:forEach items="${sessionScope.search2}" var="y">
                                              <option value="${y.wardId }">${y.wardName }</option>
											</c:forEach>
                                          </select>
                                          </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <tr>
									<td><input type="text" name="n1" value="${x.areaName}">
									</td>
										</tr>
                                          </c:forEach>
                                      </div>
									...
									<td><textarea name="n2">${x.description}</textarea></td>
                                      ...
                                      <div class="form-group">
                                              ...
                                              <c:forEach items="${sessionScope.edit}" var="x">
                                         <tr>
									<td><input type="text" name="n3" value="${x.pincode}">
									</td>
										</tr>
