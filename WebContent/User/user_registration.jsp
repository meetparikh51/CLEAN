...
var temp;
	...
	function return_validate()
	{
		...
		xmlhttp.open("get", "${pageContext.request.contextPath}/userregistration?flag=validate&email="+email.value, true);
		xmlhttp.send();	
	}
    ...
    <div id="mainwrapper">
      ...
      <div class="center">
        ...
        <div class="maincontent-full">
          <!-- Contact Form -->
          <div id="conctactleft">
                                   <h1 font color="Green" allign="center">Registration</h1>
                       
            <div id="maincontactform">
              <form action="<%=request.getContextPath()%>/userregistration" id="contactform" method="get">
               <input type="hidden" name="flag" value="insert">
              <div>
                Name: 
                <input type="text" name="name" class="textfield" id="contactname" value=""  placeholder="First name"/><span class="require"> *</span><br/>
                Address1: 
                <input type="text" name="address1" class="textfield" id="contactsubject" value="" placeholder="Address"/><span class="require"> *</span><br/>
                
                 Address2: 
                <input type="text" name="address2" class="textfield" id="contactsubject" value="" placeholder="Address"/><span class="require"> *</span><br/>
               
                E-mail:  
                <input type="text" name="email" onblur="return_validate()" class="textfield" id="email1" value="" placeholder="E-mail" /><span class="require"> *</span><br/>
                ...
                Contact no: 
                <input type="text" name="phone" class="textfield" id="contactname" value="" placeholder="+91 0123456789" /><span class="require"> *</span>   <br/>            
                <p>
                User Type: 
                                          
                                          <select class="textfield " id="aname" name="usertype"  type="text" required><span class="required">
                ...
                User Name: 
                <input type="text" name="username" class="textfield" id="contactname" value="" placeholder="User name" /><span class="require"> *</span><br/>
                Password: 
                <input type="password" name="password" class="textfield" id="contactname" value="" placeholder="Password" /><span class="require"> *</span><br/>
                Confirm Password: 
                <input type="password" name="confirmpassword" class="textfield" id="contactname" value="" placeholder="Enter Same Password" /><span class="require"> *</span><br/>
                <input type="hidden" name="usertype1" value="User">
