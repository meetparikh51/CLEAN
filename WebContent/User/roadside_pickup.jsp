    ...
    <div id="mainwrapper">
      ...
      <div class="center">
        ...
        <div class="maincontent-full">
          <!-- Contact Form -->
          <div id="conctactleft">
                                   <h1 font color="Green" allign="center">Roadside Pickup</h1>
                       
            <div id="maincontactform">
              <form action="<%=request.getContextPath()%>/roadside" id="contactform" method="get"> 
              <div>
              ...
              <div class="form-group ">
                                          ...
                                          <select class="textfield " id="zname" name="area"  type="text" required><span class="require"> *</span><br/>
                ...
                Address1: 
                <input type="text" name="add1" class="textfield" id="contactsubject" value="" placeholder="Address"/><span class="require"> *</span><br/>
                
                 Address2: 
                <input type="text" name="add2" class="textfield" id="contactsubject" value="" placeholder="Address"/><span class="require"> *</span><br/>
               
                Time: 
                <input type="text" name="time" class="textfield" id="contactemail" value="" placeholder="Time" /><span class="require"> *</span><br/>
