...
<html lang="en">
  <head>
    ...
    <!--external css-->
    <link href="${pageContext.request.contextPath }/font-awesome.css" rel="stylesheet">
             ...
             <span class="tools pull-right">
              ...
              <tr>
                 <td>${i.registrationNo}</td>
                  ...
                  <td>${i.email}</td>
                  <td>${i.address1}</td>
                 <td><a href="<%=request.getContextPath()%>/companylist?companylistid=${i.companylistId}&flag=delete">delete</a></td>
