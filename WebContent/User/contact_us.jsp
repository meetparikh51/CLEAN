...
body.bgpattern { background-image: url(images/gravel.png); background-repeat: repeat;background-size: auto;}
  ...
  <div id="wrapper">
    ...
    <div id="mainwrapper">
      ...
      <div class="center">
            ...
            <div class="breadcrumb breadcrumbs"><div class="breadcrumbs-plus"><p><span class="breadcrumbs-title">You are here: </span><a href="../Ecobizz/index.html" class="home">Home</a> <span class='separator'>&raquo;</span> Contact</p></div></div>          </div>
...
<p>Our friendly Support Team is available to help you 24 hours a day, seven days a week. We look forward to hearing from you! </p>
            ...
            <div id="maincontactform">
              ...
              <div>
                ...
                <div class="clear"></div>
                <input type="hidden" name="siteurl" id="siteurl" value="http://imediapixel.com/demo/ecobiz/wp-content/themes/ecobiz-dev" />   
                <input type="hidden" name="sendto" id="sendto" value="imediapixel@gmail.com" />           
                <a href="#" class="button medium white" id="buttonsend">SEND</a>
		...
		<div class=""><div id="google_map_389" class="google_map" style="width:424px;height:246px;"></div></div>
		<div style="line-height:0"><script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script>
		<script type="text/javascript">
		jQuery(document).ready(function($) {
			var tabs = jQuery("#google_map_389").parents(".tabs_container,.mini_tabs_container,.accordion");
			jQuery("#google_map_389").bind("initGmap",function(){
				jQuery(this).gMap({
					zoom: 15,
					markers:[{
						address: "",
						latitude: 22.990141,
						longitude: 72.487887,
						html: "Between Kataria Motor and Sanand-Sarkhej Circle,<br/>SG Highway,<br/>Ahmedabad",
						popup: true
					}],
					controls: {
	panControl: true,
	...
	overviewMapControl: true},
			...
			jQuery("#google_map_389").trigger("initGmap");
		}
	});
	</script>
	</div>            </div>
            ...
            <ul class="contactinfo">
              <li>Between Kataria Motor and Sanand-Sarkhej Circle,<br/>SG Highway,<br/>Ahmedabad</li>              <li><strong>Phone</strong> : +62 123456</li>                              <li><strong>Fax</strong> : +62 123456</li>              <li><strong>Email</strong> : <a href="mailto:imediapixel@gmail.com">imediapixel@gmail.com</a></li>            </ul>      
            <div class="clear"></div>
          </div>
          <!-- Contact Address End -->          
        </div>
...
<li><a href="http://planet.wordpress.org/">WordPress Planet</a></li>
      ...
      <div class="footerbox box-last">
        <a href="http://imediapixel.com/demo/ecobiz"><img src="images/footerlogo.png" alt="Footer Logo" class="alignleft"/></a>
        <div class="clear"></div>      

                        <ul class="social-links">
                            <li>
            <a href="http://twitter.com/imediapixel"><img src="images/twitter.png" alt="Twitter" /></a>
          </li>
                              <li>
            ...
            <a href="#"><img src="images/linkedin.png" alt="Linkedin" /></a>
                              ...
                              <li>
            <a href="skype:#?call"><img src="images/skype.png" alt="skype" /></a>
          </li>
                              <li>
            <a href="http://www.flickr.com/photos/33193193@N03"><img src="images/flickr.png" alt="Flickr" /></a>
          </li>
                              <li>
            <a href="http://www.youtube.com/user/#"><img src="images/youtube.png" alt="youtube" /></a>
          </li>
                    <li><a href="http://imediapixel.com/demo/ecobiz/feed/"><img src="images/rss.png" alt="RSS" /></a></li>
        </ul>
      ...
      <div class="bottom">
        ...
        <div class="footermenu">
          <ul id="menu-footer-menu" class=""><li id="menu-item-77" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-77"><a href="../Ecobizz/index.html">Home</a></li>
<li id="menu-item-78" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-78"><a href="../Ecobizz/about.htm">About</a></li>
...
<li id="menu-item-80" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-4 current_page_item menu-item-80"><a href="../Ecobizz/contact.htm">Contact</a></li>
</ul>        
        </div>
        <!-- Footer Menu End -->
