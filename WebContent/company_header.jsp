...
<header class="header white-bg">
            ...
            <!--logo start-->
            <a href="Company_index.jsp" class="logo"><span>Company</span></a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended n">
                            ...
                            <li><a href="<%=request.getContextPath()%>/companyregistration?flag=edit&id=${sessionScope.userID}" class=" fa fa-suitcase"></i>Edit Profile</a></li>
