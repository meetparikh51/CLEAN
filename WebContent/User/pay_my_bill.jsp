...
body.bgpattern { background-image: url("/ADMIN/User/images/gravel.png"); background-repeat: repeat;background-size: auto;}
...
<body class="page page-id-4 page-template page-template-template-contactform page-template-template-contactform-php bgpattern bgimage">
  <div id="wrapper">
    ...
    <div id="mainwrapper">
      ...
      <div class="center">
        ...
        <div class="maincontent-full">
          <!-- Contact Form -->
          <div id="conctactleft">
                                   <h1 font color="Green" allign="center">Pay bill</h1>
                       
            <div id="maincontactform">
              <form action="<%=request.getContextPath()%>/postwaste" name="areaform" id="contactform" method="get"> 
              <div>
    ...
    data-amount="500" 
    data-name="Bill" 
    data-button="buynow" src="https://www.paypalobjects.com/js/external/paypal-button.min.js?merchant=meetparikh51@gmail.com" async="async"
></script>
</div>
              <%-- 
              <div class="form-group ">
