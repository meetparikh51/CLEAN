          ...
          <section class="wrapper">
             ...
             <span class="tools pull-right">
              ...
              <tr>
                  ...
                  <td>${i.wardId.wardName}</td>
                  <td>${i.areaId.areaName}</td>
                  <td>${i.pincode}</td>
                  <td>${i.latitude}</td>
                  <td>${i.longitude}</td>
                  <td><a href="<%=request.getContextPath()%>/adddustbin?dustbinid=${i.dustbinId}&flag=edit">edit</a>/<a href="<%=request.getContextPath()%>/adddustbin?dustbinid=${i.dustbinId}&flag=delete">delete</a></td>
